...
# images = [spritesheet.parse_sprite('block1'), spritesheet.parse_sprite('block2')]

# mario = [spritesheet.parse_sprite('mario1'),spritesheet.parse_sprite('mario2'),spritesheet.parse_sprite('mario3')]
# index = 0
